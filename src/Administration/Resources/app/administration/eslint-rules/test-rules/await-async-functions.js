...
const getAsyncExpressionName = (node) => {
    // Shuwei.Component.build
    if (node.callee?.object?.object?.name === 'Shuwei' && node.callee?.object?.property?.name === 'Component' && node.callee?.property?.name === 'build') {
        return 'Shuwei.Component.build';
    }
