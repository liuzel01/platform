...
module.exports = {
    ...
    preset: '@58shuwei-ag/jest-preset-sw6-admin',
    globals: {
    ...
    transformIgnorePatterns: [
        'node_modules/(?!@58shuwei-ag/meteor-icon-kit|other)',
    ],
    ...
    moduleNameMapper: {
        ...
        '^\@58shuwei-ag\/admin-extension-sdk\/es\/(.*)': '<rootDir>/node_modules/@58shuwei-ag/admin-extension-sdk/umd/$1',
        '^lodash-es$': 'lodash',
    },
