...
const RepositoryFactory = Shuwei.Classes._private.RepositoryFactory;
const { EntityHydrator, ChangesetGenerator, EntityFactory } = Shuwei.Data;
const ErrorResolverError = Shuwei.Data.ErrorResolver;
...
export default function initializeRepositoryFactory(container: InitContainer) {
    ...
    const serviceContainer = Shuwei.Application.getContainer('service');
    ...
    return httpClient.get('_info/entity-schema.json', {
        ...
        Shuwei.Application.addServiceProvider('repositoryFactory', () => {
        ...
        Shuwei.Application.addServiceProvider('entityHydrator', () => {
            return hydrator;
        });
        Shuwei.Application.addServiceProvider('entityFactory', () => {
