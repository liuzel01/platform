...
Shuwei.Utils.debounce = function debounce(fn) {
...
describe('app/plugins/shortcut.plugin', () => {
    ...
    it('Text editor component: should be blurred on save shortcut to react to content changes', async () => {
        ...
        wrapper = await mount(await Shuwei.Component.build('base-component'), {
            attachTo: element,
            localVue,
            stubs: {
                'sw-text-editor': await Shuwei.Component.build('sw-text-editor'),
