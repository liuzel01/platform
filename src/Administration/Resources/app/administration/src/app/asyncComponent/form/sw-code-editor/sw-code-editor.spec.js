...
Shuwei.Component.register('sw-code-editor', SwCodeEditor);
...
async function createWrapper(options = {}) {
    return shallowMount(await Shuwei.Component.build('sw-code-editor'), {
...
describe('asyncComponents/form/sw-code-editor', () => {
    Shuwei.Service().register('userInputSanitizeService', () => userInputSanitizeService);
