...
Shuwei.Component.register('sw-media-list-selection-v2', SwMediaListSelectionV2);
Shuwei.Component.register('sw-media-list-selection-item-v2', swMediaListSelectionItemV2);
...
async function createWrapper() {
    return shallowMount(await Shuwei.Component.build('sw-media-list-selection-v2'), {
        ...
        stubs: {
            ...
            'sw-media-list-selection-item-v2': await Shuwei.Component.build('sw-media-list-selection-item-v2'),
            'sw-icon': true,
