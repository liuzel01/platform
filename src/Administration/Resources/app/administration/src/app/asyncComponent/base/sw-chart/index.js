...
export default {
    ...
    computed: {
        ...
        defaultLocale() {
            const adminLocaleLanguage = Shuwei.State.getters.adminLocaleLanguage;
    ...
    methods: {
        ...
        getZeroValues() {
            ...
            const fromDate = Shuwei.Utils.format.dateWithUserTimezone();
            ...
            if (this.options.xaxis.max) {
                ...
                // get actual day
                const toDate = Shuwei.Utils.format.dateWithUserTimezone();
