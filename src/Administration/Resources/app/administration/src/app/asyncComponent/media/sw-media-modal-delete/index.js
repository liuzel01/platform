...
const { Context, Mixin, Filter } = Shuwei;
    ...
    methods: {
        ...
        async updateSuccessNotification(successAmount, failureAmount, totalAmount) {
            ...
            if (this.notificationId !== null) {
                await Shuwei.State.dispatch('notification/updateNotification', {
            ...
            const newNotificationId = await Shuwei.State.dispatch('notification/createNotification', {
                variant: 'success',
                ...notification,
            });
