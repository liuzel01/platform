...
Shuwei.Component.register('sw-media-upload-v2', SwMediaUploadV2);
Shuwei.Component.register('sw-media-url-form', SwMediaUrlForm);

async function createWrapper(customOptions = {}) {
    const localVue = createLocalVue();
    localVue.directive('droppable', {});

    return shallowMount(await Shuwei.Component.build('sw-media-upload-v2'), {
        localVue,
        stubs: {
            ...
            'sw-button-group': await Shuwei.Component.build('sw-button-group'),
            'sw-context-menu-item': await Shuwei.Component.build('sw-context-menu-item'),
            'sw-media-url-form': await Shuwei.Component.build('sw-media-url-form'),
