...
Shuwei.Component.extend('sw-media-compact-upload-v2', 'sw-media-upload-v2', SwMediaCompactUploadV2);
...
describe('src/app/component/media/sw-media-compact-upload-v2', () => {
    ...
    beforeEach(async () => {
        ...
        wrapper = shallowMount(await Shuwei.Component.build('sw-media-compact-upload-v2'), {
            localVue,
            stubs: {
