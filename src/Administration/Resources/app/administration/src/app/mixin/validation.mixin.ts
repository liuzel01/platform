...
Shuwei.Mixin.register('validation', {
    ...
    methods: {
        ...
        validate(value: any) {
            ...
            if (Shuwei.Utils.types.isBoolean(validation)) {
                return validation;
            }

            if (Shuwei.Utils.types.isString(validation)) {
            ...
            if (Shuwei.Utils.types.isArray(validation)) {
                valid = validation.every((validationRule) => {
                    if (Shuwei.Utils.types.isBoolean(validationRule)) {
