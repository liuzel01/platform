...
export default Shuwei.Mixin.register('user-settings', defineComponent({
    ...
    methods: {
        ...
        async saveUserSettings(identifier: string, entityValue: {
            ...
            if (!userSettings) {
                userSettings = this.userConfigRepository.create(Shuwei.Context.api);
            }
            ...
            return this.userConfigRepository.save(entityData, Shuwei.Context.api);
        },
        ...
        userGridSettingsCriteria(identifier: string, userId: string|null = null) {
            ...
            const criteria = new Shuwei.Data.Criteria(1, 25);
            criteria.addFilter(Shuwei.Data.Criteria.equals('key', identifier));
            criteria.addFilter(Shuwei.Data.Criteria.equals('userId', userId));
