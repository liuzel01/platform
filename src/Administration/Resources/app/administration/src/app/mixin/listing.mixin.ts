...
Shuwei.Mixin.register('listing', {
    ...
    created() {
        ...
        if (Shuwei.Utils.types.isEmpty(actualQueryParameters)) {
            this.resetListing();
        } else {
    ...
    watch: {
        ...
        '$route'(newRoute, oldRoute) {
            ...
            if (Shuwei.Utils.types.isEmpty(query)) {
                this.resetListing();
            }
        ...
        selection() {
            Shuwei.State.commit('shuweiApps/setSelectedIds', Object.keys(this.selection));
        },
    ...
    methods: {
        ...
        updateRoute(customQuery: {
            ...
            if (Shuwei.Utils.types.isEmpty(routeQuery)) {
