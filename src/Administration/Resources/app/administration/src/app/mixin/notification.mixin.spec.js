...
describe('src/app/mixin/notification.mixin.ts', () => {
    ...
    beforeEach(async () => {
        if (originalDispatch) {
            Object.defineProperty(Shuwei.State, 'dispatch', {
                value: originalDispatch,
            });
        } else {
            originalDispatch = Shuwei.State.dispatch;
        }
    ...
    it('should dispatch a notification on createNotification', () => {
        ...
        expect(Shuwei.State.dispatch).toHaveBeenCalledWith('notification/createNotification', {
            message: 'The unique message',
        });
    });
