...
import type { ApiContext } from '@58shuwei-ag/admin-extension-sdk/es/data/_internals/EntityCollection';
...
export default function initializeWorker() {
    ...
    const context = Shuwei.Context.app;
    const workerNotificationFactory = Shuwei.Application.getContainer('factory').workerNotification;
    const configService = Shuwei.Service('configService');
    ...
    function getConfig() {
        return configService.getConfig().then((response) => {
            Object.entries(response as { [key: string]: unknown}).forEach(([key, value]) => {
                Shuwei.State.commit('context/addAppConfigValue', { key, value });
            });
            ...
            if (context.config.adminWorker?.enableAdminWorker && !enabled) {
                enableAdminWorker(loginService, Shuwei.Context.api, context.config.adminWorker);
            }
        });
    }
...
function registerThumbnailMiddleware(factory: typeof WorkerNotificationFactory) {
    ...
    factory.register('DalIndexingMessage', {
        name: 'Shuwei\\Core\\Framework\\DataAbstractionLayer\\Indexing\\MessageQueue\\IndexerMessage',
    ...
    factory.register('EsIndexingMessage', {
        name: 'Shuwei\\Elasticsearch\\Framework\\Indexing\\IndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('generateThumbnailsMessage', {
        name: 'Shuwei\\Core\\Content\\Media\\Message\\GenerateThumbnailsMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('PromotionIndexingMessage', {
        name: 'Shuwei\\Core\\Checkout\\Promotion\\DataAbstractionLayer\\PromotionIndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('ProductStreamIndexingMessage', {
        name: 'Shuwei\\Core\\Content\\ProductStream\\DataAbstractionLayer\\ProductStreamIndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('CategoryIndexingMessage', {
        name: 'Shuwei\\Core\\Content\\Category\\DataAbstractionLayer\\CategoryIndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('MediaIndexingMessage', {
        name: 'Shuwei\\Core\\Content\\Media\\DataAbstractionLayer\\MediaIndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('RuleIndexingMessage', {
        name: 'Shuwei\\Core\\Content\\Rule\\DataAbstractionLayer\\RuleIndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('ProductIndexingMessage', {
        name: 'Shuwei\\Core\\Content\\Product\\DataAbstractionLayer\\ProductIndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('ElasticSearchIndexingMessage', {
        name: 'Shuwei\\Elasticsearch\\Framework\\Indexing\\ElasticsearchIndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
            messageQueueNotification('esIndexing', ids, next, entry, $root, notification, {
                title: 'global.default.success',
                message: 'global.notification-center.worker-listener.esIndexing.message',
    ...
    factory.register('ImportExportMessage', {
        name: 'Shuwei\\Core\\Content\\ImportExport\\Message\\ImportExportMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('FlowIndexingMessage', {
        name: 'Shuwei\\Core\\Content\\Flow\\Indexing\\FlowIndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
    ...
    factory.register('NewsletterRecipientIndexingMessage', {
        name: 'Shuwei\\Core\\Content\\Newsletter\\DataAbstractionLayer\\NewsletterRecipientIndexingMessage',
        fn: function middleware(next, { entry, $root, notification }) {
