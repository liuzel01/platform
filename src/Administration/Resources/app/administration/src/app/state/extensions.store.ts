...
import type { extension } from '@58shuwei-ag/admin-extension-sdk/es/privileges/privilege-resolver';
import type { extensions } from '@58shuwei-ag/admin-extension-sdk/es/channel';
