...
describe('src/app/component/structure/sw-search-bar', () => {
    ...
    async function createWrapper(props, searchTypes = searchTypeServiceTypes, privileges = []) {
        ...
        swSearchBarComponent = await Shuwei.Component.build('sw-search-bar');
        ...
        return shallowMount(swSearchBarComponent, {
            ...
            stubs: {
                ...
                'sw-search-bar-item': await Shuwei.Component.build('sw-search-bar-item'),
    ...
    beforeAll(async () => {
        ...
        const apiService = Shuwei.Application.getContainer('factory').apiService;
    ...
    it('should search global with ES when adminEsEnable is true', async () => {
        Shuwei.Context.app.adminEsEnable = true;
        wrapper = await createWrapper({
            initialSearchType: '',
        }, {
            all: {
