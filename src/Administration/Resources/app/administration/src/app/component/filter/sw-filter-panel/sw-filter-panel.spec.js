...
async function createWrapper() {
    return shallowMount(await Shuwei.Component.build('sw-filter-panel'), {
        propsData: {
            title: 'Filter',
            entity: 'product',
            filters,
        ...
        stubs: {
            'sw-boolean-filter': await Shuwei.Component.build('sw-boolean-filter'),
            ...
            'sw-icon': true,
            'sw-existence-filter': await Shuwei.Component.build('sw-existence-filter'),
...
Shuwei.Service().register('filterService', () => {
    return {
