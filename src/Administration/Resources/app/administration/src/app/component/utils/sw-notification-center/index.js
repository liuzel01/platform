...
Component.register('sw-notification-center', {
    ...
    computed: {
        notifications() {
            return Shuwei.State.getters['notification/getNotifications'];
        },
    ...
    created() {
        this.unsubscribeFromStore = Shuwei.State.subscribeAction(this.createNotificationFromSystemError);
    ...
    methods: {
        onContextMenuOpen() {
            Shuwei.State.commit('notification/setWorkerProcessPollInterval', POLL_FOREGROUND_INTERVAL);
        },
        onContextMenuClose() {
            Shuwei.State.dispatch('notification/setAllNotificationsVisited');
            Shuwei.State.commit('notification/setWorkerProcessPollInterval', POLL_BACKGROUND_INTERVAL);
        },
        openDeleteModal() {
