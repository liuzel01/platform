...
async function createWrapper({ propsData = {}, privileges = [] } = {}) {
    ...
    const aclService = new AclService(Shuwei.State);

    return shallowMount(await Shuwei.Component.build('sw-admin-menu-item'), {
        propsData: propsData,
        stubs: {
            'sw-icon': true,
...
describe('src/app/component/structure/sw-admin-menu-item', () => {
    ...
    it('should match route', async () => {
        ...
        Shuwei.State.commit('adminMenu/setAdminModuleNavigation', entries);
