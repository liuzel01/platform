...
async function createWrapper(allowInlineDataMapping = true) {
    ...
    return shallowMount(await Shuwei.Component.build('sw-text-editor'), {
        ...
        localVue,
        stubs: {
            'sw-text-editor-toolbar-button': await Shuwei.Component.build('sw-text-editor-toolbar-button'),
            'sw-text-editor-link-menu': await Shuwei.Component.build('sw-text-editor-link-menu'),
            'sw-compact-colorpicker': await Shuwei.Component.build('sw-compact-colorpicker'),
            'sw-text-editor-toolbar': await Shuwei.Component.build('sw-text-editor-toolbar'),
            ...
            'sw-colorpicker': await Shuwei.Component.build('sw-colorpicker'),
            'sw-text-field': await Shuwei.Component.build('sw-text-field'),
            'sw-base-field': await Shuwei.Component.build('sw-base-field'),
            'sw-container': await Shuwei.Component.build('sw-container'),
...
describe('src/app/component/form/sw-text-editor', () => {
    ...
    it('should show the link url when you select a text block with a link', async () => {
        ...
        await addAndCheckSelection(wrapper, linkText, 0, 8, 'Shuwei');
        document.dispatchEvent(new Event('mouseup'));
    ...
    it('should be able to switch from active link to non link text', async () => {
        ...
        // select "No Link" after the "Shuwei" link was selected before
        const paragraphWithoutLink = document.getElementById('paragraphWithoutLink');
    ...
    it('should be able to switch from one link to another link', async () => {
        ...
        await addAndCheckSelection(wrapper, linkOne, 0, 8, 'Shuwei');
        document.dispatchEvent(new Event('mouseup'));
        ...
        // select "Google" after the "Shuwei" link was selected before
