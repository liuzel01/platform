...
Component.register('sw-snippet-field-edit-modal', {
    ...
    computed: {
        ...
        currentAuthor() {
            return `user/${Shuwei.State.get('session').currentUser.username}`;
        },
    ...
    methods: {
        createdComponent() {
            ...
            this.snippetSets.forEach((snippetSet) => {
                ...
                const snippet = this.snippetRepository.create(Shuwei.Context.api);
        ...
        onSave() {
            ...
            this.editableSnippets.forEach((snippet) => {
                ...
                if (snippet.origin !== snippet.value) {
                    ...
                    responses.push(
                        this.snippetRepository.save(snippet, Shuwei.Context.api),
                    );
                    ...
                    responses.push(
                        this.snippetRepository.delete(snippet.id, Shuwei.Context.api),
                    );
                }
            });
