...
const { Component, State, Data: { Criteria } } = Shuwei;
...
Component.register('sw-snippet-field', {
    ...
    computed: {
        ...
        languageCriteria() {
            ...
            criteria.addFilter(Criteria.equals('id', Shuwei.Context.api.systemLanguageId));
    ...
    methods: {
        async createdComponent() {
            ...
            this.snippetSets = await this.snippetSetRepository.search(new Criteria(1, 25), Shuwei.Context.api);
        ...
        async getSystemDefaultLocale() {
            const languages = await this.languageRepository.search(this.languageCriteria, Shuwei.Context.api);
