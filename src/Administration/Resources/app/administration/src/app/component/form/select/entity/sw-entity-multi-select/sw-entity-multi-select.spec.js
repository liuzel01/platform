...
const createEntityMultiSelect = async (customOptions) => {
    ...
    const options = {
        ...
        stubs: {
            ...
            'sw-icon': await Shuwei.Component.build('sw-icon'),
            ...
            'sw-product-variant-info': await Shuwei.Component.build('sw-product-variant-info'),
    ...
    return shallowMount(await Shuwei.Component.build('sw-entity-multi-select'), {
        ...options,
        ...customOptions,
    });
};
