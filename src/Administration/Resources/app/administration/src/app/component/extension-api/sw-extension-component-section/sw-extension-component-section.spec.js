...
describe('src/app/component/extension-api/sw-extension-component-section', () => {
    ...
    async function createWrapper() {
        return mount(await Shuwei.Component.build('sw-extension-component-section'), {
            propsData: {
    ...
    beforeEach(async () => {
        Vue.set(Shuwei.State.get('extensionComponentSections'), 'identifier', {});
    });
    ...
    it('should not render tabs in card section', async () => {
        Shuwei.State.commit('extensionComponentSections/addSection', {
            component: 'card',
