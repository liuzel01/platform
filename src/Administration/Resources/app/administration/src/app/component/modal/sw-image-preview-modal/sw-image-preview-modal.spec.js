...
Shuwei.Component.register('sw-image-slider', SwImageSlider);
...
async function createWrapper(propsData = {}, listeners = {}) {
    return shallowMount(await Shuwei.Component.build('sw-image-preview-modal'), {
        stubs: {
            'sw-icon': true,
            'sw-image-slider': await Shuwei.Component.build('sw-image-slider'),
        },
        listeners,
        propsData: {
            mediaItems,
