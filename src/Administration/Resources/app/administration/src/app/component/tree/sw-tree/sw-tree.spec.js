...
async function createWrapper() {
    ...
    return shallowMount(await Shuwei.Component.build('sw-tree'), {
        localVue,
        stubs: {
            ...
            'sw-vnode-renderer': await Shuwei.Component.build('sw-vnode-renderer'),
            'sw-icon': true,
            'sw-tree-item': await Shuwei.Component.build('sw-tree-item'),
        },
        mocks: {
            $route: {
                params: [
