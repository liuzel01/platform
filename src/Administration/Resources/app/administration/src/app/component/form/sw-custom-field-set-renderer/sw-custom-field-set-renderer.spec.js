...
async function createWrapper(props) {
    ...
    return shallowMount(await Shuwei.Component.build('sw-custom-field-set-renderer'), {
        localVue,
        propsData: props,
        stubs: {
            'sw-button': await Shuwei.Component.build('sw-button'),
            'sw-label': await Shuwei.Component.build('sw-label'),
            'sw-tabs': await Shuwei.Component.build('sw-tabs'),
            'sw-tabs-item': await Shuwei.Component.build('sw-tabs-item'),
            ...
            'sw-skeleton': await Shuwei.Component.build('sw-skeleton'),
            'sw-skeleton-bar': await Shuwei.Component.build('sw-skeleton-bar'),
        },
        provide: {
            repositoryFactory: {
                create: (entity) => ({
