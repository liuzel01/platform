...
Component.register('sw-category-tree-field', {
    ...
    methods: {
        ...
        getTreeItems(parentId = null) {
            ...
            return this.globalCategoryRepository.search(criteria, Shuwei.Context.api).then((searchResult) => {
        ...
        searchCategories(term) {
            ...
            // search for categories
            return this.globalCategoryRepository.search(categorySearchCriteria, Shuwei.Context.api);
        },
