 ...
 */
Shuwei.Component.register('sw-iframe-renderer', {
    template,
    ...
    created() {
        this.heightHandler = Shuwei.ExtensionAPI.handle('locationUpdateHeight', ({ height, locationId }) => {
    ...
    computed: {
        componentName(): string|undefined {
            return Shuwei.State.get('sdkLocation').locations[this.locationId];
        },

        extension(): Extension | undefined {
            const extensions = Shuwei.State.get('extensions');
