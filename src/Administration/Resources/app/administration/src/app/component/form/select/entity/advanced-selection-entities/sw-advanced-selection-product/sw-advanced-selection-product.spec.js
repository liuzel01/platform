...
function mockContext() {
    return {
        apiPath: 'http://shuwei.local/api',
        apiResourcePath: 'http://shuwei.local/api/v2',
        assetsPath: 'http://shuwei.local/bundles/',
        basePath: '',
        host: 'shuwei.local',
        inheritance: false,
        installationPath: 'http://shuwei.local',
        languageId: '2fbb5fe2e29a4d70aa5854ce7ce3e20b',
        liveVersionId: '0fa91ce3e96a4bc2be4bd9ce752c3425',
        pathInfo: '/admin',
        port: 80,
        scheme: 'http',
        schemeAndHttpHost: 'http://shuwei.local',
        uri: 'http://shuwei.local/admin',
    };
}
...
async function createWrapper() {
    ...
    return {
        wrapper: shallowMount(await Shuwei.Component.build('sw-advanced-selection-product'), {
            localVue,
            provide: {
                acl: {
                    can: () => true,
            ...
            stubs: {
                'sw-entity-advanced-selection-modal': await Shuwei.Component.build('sw-entity-advanced-selection-modal'),
                ...
                'sw-card-filter': await Shuwei.Component.build('sw-card-filter'),
