...
const { Component, Mixin, Utils } = Shuwei;
const { Criteria, EntityCollection } = Shuwei.Data;
const { debounce, get } = Shuwei.Utils;
    ...
    methods: {
        ...
        createNewEntity() {
            ...
            this.repository.save(entity, this.context).then(() => {
                ...
                Shuwei.Utils.debug.error('Only Entities with "name" as the only required field are creatable.');
                this.isLoading = false;
            });
        },
