...
Component.register('sw-data-grid', {
    ...
    methods: {
        ...
        findUserSettingById() {
            return this.userConfigRepository.get(this.currentSetting.id, Shuwei.Context.api).then((response) => {
                if (!response) {
                    return;
                }
        ...
        createUserGridSetting() {
            const newUserGrid = this.userConfigRepository.create(Shuwei.Context.api);
        ...
        saveUserSettings() {
            ...
            this.userConfigRepository.save(this.currentSetting, Shuwei.Context.api).then(() => {
