...
const { mapState } = Shuwei.Component.getComponentHelper();

/**
 * @private
 */
Shuwei.Component.register('sw-license-violation', {
    template,
    ...
    computed: {
        ...
        pluginCriteria() {
            return new Shuwei.Data.Criteria(1, 50);
        },
        ...
        getPluginViolation() {
            ...
            return this.licenseViolationService.checkForLicenseViolations()
                .then(({ violations, warnings, other }) => {
                    Shuwei.State.commit('licenseViolation/setViolations', violations);
                    Shuwei.State.commit('licenseViolation/setWarnings', warnings);
                    Shuwei.State.commit('licenseViolation/setOther', other);
                })
                .finally(() => {
