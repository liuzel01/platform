...
describe('src/app/component/structure/sw-language-switch', () => {
    ...
    beforeEach(async () => {
        ...
        wrapper = shallowMount(await Shuwei.Component.build('sw-language-switch'), {
            localVue,
            stubs: {
    ...
    it('should change the language', async () => {
        ...
        expect(Shuwei.State.get('context').api.languageId).toBe('123');

        wrapper.vm.onInput('456');

        expect(Shuwei.State.get('context').api.languageId).toBe('456');
    });
