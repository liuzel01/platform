...
Component.register('sw-filter-panel', {
        ...
        criteria: {
            handler() {
                if (this.filterChanged) {
                    Shuwei.Service('filterService').saveFilters(this.storeKey, this.storedFilters).then(response => {
    ...
    methods: {
        createdComponent() {
            Shuwei.Service('filterService').getStoredFilters(this.storeKey).then(filters => {
                this.activeFilters = {};
