...
const { Criteria, EntityCollection } = Shuwei.Data;
...
async function createWrapper(customOptions) {
    ...
    const options = {
        localVue,
        stubs: {
            'sw-base-filter': await Shuwei.Component.build('sw-base-filter'),
            ...
            'sw-loader': await Shuwei.Component.build('sw-loader'),
    ...
    return shallowMount(await Shuwei.Component.build('sw-multi-select-filter'), {
        ...options,
        ...customOptions,
    });
}
