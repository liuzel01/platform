...
Component.register('sw-property-search', {
    ...
    methods: {
        ...
        showSearch() {
            ...
            this.propertyGroupOptionRepository.search(this.propertyGroupOptionCriteria, Shuwei.Context.api)
                .then((groupOptions) => {
        ...
        loadGroups() {
            this.propertyGroupRepository.search(this.propertyGroupCriteria, Shuwei.Context.api).then((groups) => {
                this.groups = groups;
        ...
        loadOptions() {
            ...
            this.propertyGroupOptionRepository.search(criteria, Shuwei.Context.api)
                .then((groupOptions) => {
