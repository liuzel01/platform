const { remove } = Shuwei.Utils.array;
const { Service } = Shuwei;
...
export default function createCustomFieldService() {
    ...
    function getCustomFieldSets(entityName) {
        ...
        return customFieldSetRepository.search(customFieldSetCriteria(entityName), Shuwei.Context.api).then((sets) => {
