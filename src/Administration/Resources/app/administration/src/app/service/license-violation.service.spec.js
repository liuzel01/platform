...
const Application = Shuwei.Application;
...
describe('app/service/license-violation.service.js', () => {
    Shuwei.Service().register('shuweiExtensionService', () => extensionApiServiceMock);
    Shuwei.Service().register('cacheApiService', () => cacheApiServiceMock);
