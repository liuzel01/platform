 ...
 */
export default function setupShuweiDevtools(app: App): void {
    setupDevtoolsPlugin({
        // Options
        id: 'sw-admin-extension-plugin',
        label: 'Shuwei Admin extensions plugin',
        ...
        api.on.getInspectorTree((payload) => {
            ...
            const publishedDatasets = Shuwei.ExtensionAPI.getPublishedDataSets();
        ...
        api.on.getInspectorState((payload) => {
            ...
            if (payload.nodeId.startsWith(DATASET_ID_PREFIX)) {
                ...
                const value = Shuwei.ExtensionAPI.getPublishedDataSets()
