...
import setupShuweiDevtools from 'src/app/adapter/view/sw-vue-devtools';
import Vue from 'vue';
...
Shuwei.Service().register('localeHelper', () => {
    return {
...
describe('ASYNC app/adapter/view/vue.adapter.js', () => {
    ...
    beforeEach(async () => {
        ...
        if (!Shuwei.Service('loginService')) {
        ...
        if (!Shuwei.Service('localeToLanguageService')) {
            Shuwei.Service().register('localeToLanguageService', () => {
                return {
        ...
        Shuwei.State.get('system').locales = ['en-US', 'zh-CN'];
    ...
    it('setLocaleFromUser should not set the user when user does not exists', async () => {
        ...
        expect(Shuwei.Service('localeHelper').setLocaleWithId).not.toHaveBeenCalled();
    });
    ...
    it('setLocaleFromUser should set the user when user does not exists', async () => {
        ...
        expect(Shuwei.Service('localeHelper').setLocaleWithId).toHaveBeenCalled();
    });
    ...
    it('setLocaleFromUser should call the service with the user id from the store', async () => {
        ...
        expect(Shuwei.Service('localeHelper').setLocaleWithId).toHaveBeenCalledWith(expectedId);
    });

    it('should resolve mixins by explicit Mixin get by name call', async () => {
        Shuwei.Mixin.register('foo1', {
            methods: {
                fooBar() {
                    return this.title;
                },
        ...
        Shuwei.Component.register('test-component1', {
            template: '<div></div>',
    ...
    it('should resolve mixins by explicit Mixin get by name call with override', async () => {
        ...
        Shuwei.Component.register('test-component2', {
            template: '<div></div>',
        ...
        Shuwei.Component.override('test-component2', {
            data() {
                return {
    ...
    it('should resolve mixins by string', async () => {
        ...
        Shuwei.Component.register('test-component3', {
            template: '<div></div>',
    ...
    it('should resolve mixins by string with override', async () => {
        ...
        Shuwei.Component.register('test-component4', {
            template: '<div></div>',
        ...
        Shuwei.Component.override('test-component4', {
            data() {
                return {
    ...
    it('should resolve mixins for component in combination with overrides', async () => {
        Shuwei.Mixin.register('foo-with-data', {
            data() {
                return {
                    sortBy: null,
                };
        ...
        Shuwei.Component.register('test-component-foobar-with-mixin', {
            template: '<div></div>',
            name: 'test-component',
            data() {
                return {
    ...
    it('should extend mixins', async () => {
        ...
        Shuwei.Component.register('extendable-component', {
        ...
        Shuwei.Component.extend('sw-test-component-extended', 'extendable-component', {
    ...
    it('should allow multi-inheritance with multiple mixins and lifecycle hooks are only executed once', async () => {
        ...
        Shuwei.Mixin.register('first-mixin', {
            created() {
                lifecycleSpy();
            },
            methods: {
        ...
        Shuwei.Mixin.register('second-mixin', {
            methods: {
                bar() { return 'bar'; },
            },
        });

        Shuwei.Component.register('base-component', {
            template: '<div class="base-component"></div>',
        });

        Shuwei.Component.override('base-component', {
            mixins: ['first-mixin'],
        });
    ...
    describe('should initialize everything correctly', () => {
        ...
        beforeEach(async () => {
            ...
            if (!Shuwei.Filter.getByName('my-mock-filter')) {
                Shuwei.Filter.register('my-mock-filter', () => {
                    return 'mocked';
                });
            }

            if (!Shuwei.Directive.getByName('my-mock-directive')) {
                Shuwei.Directive.register('my-mock-directive', () => {
                    return {
                        bind() {},
                        inserted() {},
                        update() {},
            ...
            // add main component
            if (!Shuwei.Component.getComponentRegistry().has('sw-admin')) {
                Shuwei.Component.register('sw-admin', {
                    template: '<div class="sw-admin"></div>',
                });
            }

            // add VueAdapter to Shuwei object
            Shuwei.Application.setViewAdapter(vueAdapter);
        ...
        it('should have correct working createTitle method', () => {
            ...
            expect(result).toBe('Test | Mock title | Text Shuwei Admin');
        });
        ...
        it('should setup the devtools in development environment', async () => {
            expect(setupShuweiDevtools).toHaveBeenCalled();
        });
