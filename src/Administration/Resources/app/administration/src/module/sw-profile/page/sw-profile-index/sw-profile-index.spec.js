...
Shuwei.Component.register('sw-profile-index', swProfileIndex);

async function createWrapper(privileges = []) {
    const localVue = createLocalVue();
    localVue.directive('tooltip', {});

    return shallowMount(await Shuwei.Component.build('sw-profile-index'), {
        localVue,
        stubs: {
            'sw-page': {
...
describe('src/module/sw-profile/page/sw-profile-index', () => {
    ...
    it('should be able to change new password', async () => {
        ...
        wrapper.vm.onChangeNewPassword('Shuwei');

        expect(wrapper.vm.newPassword).toBe('Shuwei');
    });
    ...
    it('should be able to change new password confirm', async () => {
        ...
        wrapper.vm.onChangeNewPasswordConfirm('Shuwei');

        expect(wrapper.vm.newPasswordConfirm).toBe('Shuwei');
    });
