...
Shuwei.Component.register('sw-profile-index-search-preferences', swProfileIndexSearchPreferences);
...
async function createWrapper() {
    ...
    return shallowMount(await Shuwei.Component.build('sw-profile-index-search-preferences'), {
        localVue,
        stubs: {
...
describe('src/module/sw-profile/view/sw-profile-index-search-preferences', () => {
    beforeAll(() => {
        Shuwei.State.registerModule('swProfile', swProfileStateMock);
    });
    ...
    it('should be able to select all', async () => {
        ...
        await Shuwei.State.commit('swProfile/setSearchPreferences', [{
            entityName: 'product',
            _searchable: false,
            fields: [
                {
    ...
    it('should contain a computed property, calling: defaultSearchPreferences', async () => {
        ...
        await Shuwei.State.commit('swProfile/setUserSearchPreferences', [
            {
                order: {
                    documents: {
