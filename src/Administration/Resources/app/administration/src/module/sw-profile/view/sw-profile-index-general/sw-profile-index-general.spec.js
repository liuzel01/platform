...
Shuwei.Component.register('sw-profile-index-general', swProfileIndexGeneral);

async function createWrapper(privileges = []) {
    const localVue = createLocalVue();

    return shallowMount(await Shuwei.Component.build('sw-profile-index-general'), {
        localVue,
        stubs: {
            'sw-card': true,
            'sw-container': true,
...
describe('src/module/sw-profile/view/sw-profile-index-general', () => {
    ...
    it('should be able to change new password', async () => {
        ...
        await wrapper.setData({
            computedNewPassword: 'Shuwei',
        });

        expect(spyNewPasswordChangeEmit).toHaveBeenCalledWith('new-password-change', 'Shuwei');
    });
    ...
    it('should be able to change new password confirm', async () => {
        ...
        await wrapper.setData({
            computedNewPasswordConfirm: 'Shuwei',
        });

        expect(spyNewPasswordConfirmChangeEmit).toHaveBeenCalledWith('new-password-confirm-change', 'Shuwei');
    });
