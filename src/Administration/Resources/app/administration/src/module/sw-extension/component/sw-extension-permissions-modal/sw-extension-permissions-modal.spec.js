...
Shuwei.Component.register('sw-extension-permissions-modal', swExtensionPermissionsModal);

async function createWrapper(propsData) {
    const localVue = createLocalVue();
    localVue.filter('asset', v => v);

    return shallowMount(await Shuwei.Component.build('sw-extension-permissions-modal'), {
        localVue,
        propsData: {
            ...propsData,
        },
