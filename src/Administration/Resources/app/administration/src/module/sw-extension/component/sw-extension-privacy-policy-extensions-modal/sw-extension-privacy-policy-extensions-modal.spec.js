...
Shuwei.Component.register('sw-extension-privacy-policy-extensions-modal', swExtensionPrivacyPolicyExtensionsModal);

async function createWrapper(props) {
    return shallowMount(await Shuwei.Component.build('sw-extension-privacy-policy-extensions-modal'), {
        propsData: {
            ...props,
        },
        mocks: {
