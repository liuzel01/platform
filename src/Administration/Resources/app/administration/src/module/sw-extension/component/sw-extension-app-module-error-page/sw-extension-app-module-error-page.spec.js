...
Shuwei.Component.register('sw-extension-app-module-error-page', SwExtensionMyAppsErrorPage);
const routerMock = {
    go: jest.fn(),
};

async function createWrapper() {
    return shallowMount(await Shuwei.Component.build('sw-extension-app-module-error-page'), {
        stubs: {
