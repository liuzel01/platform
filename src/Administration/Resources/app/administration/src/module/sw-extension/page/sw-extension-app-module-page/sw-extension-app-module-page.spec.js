...
Shuwei.Component.register('sw-extension-app-module-page', SwExtensionsAppModulePage);
Shuwei.Component.register('sw-extension-my-apps-error-page', SwExtensionsAppModuleErrorPage);
...
describe('src/module/sw-extension/page/sw-extension-app-module-page/index.js', () => {
    ...
    async function createWrapper(propsData) {
        ...
        // @ts-ignore
        return shallowMount(await Shuwei.Component.build('sw-extension-app-module-page'), {
            localVue,
            propsData,
            stubs: {
                'sw-extension-app-module-error-page': await Shuwei.Component.build('sw-extension-my-apps-error-page'),
    ...
    it('sets the correct heading and source with a regular module', async () => {
        ...
        expect(wrapper.get('iframe#app-content').attributes('src')).toBe('https://shuwei.apps/module1');
    });
    ...
    it('sets the correct heading and source with a main module', async () => {
        ...
        expect(wrapper.get('iframe#app-content').attributes('src')).toBe('https://shuwei.apps/login');
    });
