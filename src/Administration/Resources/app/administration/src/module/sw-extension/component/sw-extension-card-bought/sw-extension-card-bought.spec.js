...
Shuwei.Component.register('sw-extension-card-base', swExtensionCardBase);
Shuwei.Component.extend('sw-extension-card-bought', 'sw-extension-card-base', swExtensionCardBought);
Shuwei.Component.register('sw-extension-removal-modal', swExtensionRemovalModal);
...
Shuwei.Application.addServiceProvider('loginService', () => {
    return {
...
Shuwei.Application.addServiceProvider('extensionStoreActionService', () => {
    return extensionStoreActionService;
});

Shuwei.Application.addServiceProvider('shuweiExtensionService', () => {
...
Shuwei.Application.addServiceProvider('extensionErrorService', () => {
...
async function createWrapper(extension) {
    return shallowMount(await Shuwei.Component.build('sw-extension-card-bought'), {
        propsData: {
            extension,
        },
        mocks: {
        ...
        mixins: [
            Shuwei.Mixin.getByName('sw-extension-error'),
        ],
        stubs: {
            'sw-meteor-card': true,
            ...
            'sw-extension-removal-modal': await Shuwei.Component.build('sw-extension-removal-modal'),
            'sw-modal': await Shuwei.Component.build('sw-modal'),
            'sw-button': await Shuwei.Component.build('sw-button'),
            'sw-extension-adding-failed': await Shuwei.Component.build('sw-extension-adding-failed'),
        ...
        provide: {
            ...
            extensionErrorService: Shuwei.Service('extensionErrorService'),
            cacheApiService: {},
            shortcutService: {
                stopEventListener: () => {},
                startEventListener: () => {},
