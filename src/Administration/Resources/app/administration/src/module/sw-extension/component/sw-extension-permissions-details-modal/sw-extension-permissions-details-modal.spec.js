...
Shuwei.Component.register('sw-extension-permissions-details-modal', swExtensionPermissionDetailsModal);

async function createWrapper({ permissions, modalTitle, selectedEntity }) {
    const localVue = createLocalVue();
    localVue.filter('asset', v => v);

    return shallowMount(await Shuwei.Component.build('sw-extension-permissions-details-modal'), {
        localVue,
        propsData: {
            permissions,
            modalTitle,
