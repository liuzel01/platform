...
const { ShuweiError } = Shuwei.Classes;
...
export default {
    ...
    computed: {
        ...
        installedVersion() {
            const installedExtension = Shuwei.State.get('shuweiExtensions').myExtensions.data.find(
    ...
    methods: {
        ...
        validateHeadline() {
            if (this.headline === null || this.headline === '') {
                this.errors.headlineError = new ShuweiError({
        ...
        validateRating() {
            if (this.rating === null || this.rating === 0) {
                this.errors.ratingError = new ShuweiError({
                    code: 'c1051bb4-d103-4f74-8988-acbcafc7fdc3',
                });
