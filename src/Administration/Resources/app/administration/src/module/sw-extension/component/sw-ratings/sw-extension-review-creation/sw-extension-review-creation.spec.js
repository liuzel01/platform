...
Shuwei.Component.register('sw-extension-review-creation', swExtensionReviewCreation);
Shuwei.Component.register('sw-extension-review-creation-inputs', swExtensionReviewCreationInputs);
Shuwei.Component.extend('sw-extension-select-rating', 'sw-text-field', swExtensionSelectRating);
Shuwei.Component.register('sw-extension-rating-stars', swExtensionRatingStars);
...
describe('src/module/sw-extension/component/sw-ratings/sw-extension-review-creation', () => {
    ...
    async function createWrapper() {
        return shallowMount(await Shuwei.Component.build('sw-extension-review-creation'), {
            propsData: {
                extension: {},
            },
            provide: {
            ...
            stubs: {
                'sw-extension-review-creation-inputs': await Shuwei.Component.build('sw-extension-review-creation-inputs'),
                ...
                'sw-extension-select-rating': await Shuwei.Component.build('sw-extension-select-rating'),
                'sw-extension-rating-stars': await Shuwei.Component.build('sw-extension-rating-stars'),
                'sw-checkbox-field': await Shuwei.Component.build('sw-checkbox-field'),
                'sw-icon': true,
                'sw-textarea-field': {
                    template: '<textarea></textarea>',
                },
                'sw-gtc-checkbox': await Shuwei.Component.build('sw-gtc-checkbox'),
                'sw-button': await Shuwei.Component.build('sw-button'),
                'sw-button-process': await Shuwei.Component.build('sw-button-process'),
                'sw-external-link': await Shuwei.Component.build('sw-external-link'),
                'sw-loader': true,
            },
        });
    }
