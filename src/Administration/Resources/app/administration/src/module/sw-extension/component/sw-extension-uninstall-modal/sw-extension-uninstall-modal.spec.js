...
Shuwei.Component.register('sw-extension-uninstall-modal', swExtensionUninstallModal);

async function createWrapper(propsData = {}) {
    return shallowMount(await Shuwei.Component.build('sw-extension-uninstall-modal'), {
        propsData: {
