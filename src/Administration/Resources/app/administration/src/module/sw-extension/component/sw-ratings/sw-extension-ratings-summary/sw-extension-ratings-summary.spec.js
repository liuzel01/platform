...
Shuwei.Component.register('sw-extension-ratings-summary', swExtensionRatingsSummary);
...
describe('src/module/sw-extension/component/sw-ratings/sw-extension-ratings-summary', () => {
    async function createWrapper() {
        return shallowMount(await Shuwei.Component.build('sw-extension-ratings-summary'), {
            propsData: {
                summary: {
                    ratingAssignment: [
                        { rating: 5, count: 5 },
            ...
            stubs: {
                ...
                'sw-progress-bar': await Shuwei.Component.build('sw-progress-bar'),
            },
            provide: {
                userActivityService: {
