...
Shuwei.Component.register('sw-extension-file-upload', swExtensionFileUpload);

async function createWrapper(userConfig = {}) {
    return shallowMount(await Shuwei.Component.build('sw-extension-file-upload'), {
        stubs: {
...
describe('src/module/sw-extension/component/sw-extension-file-upload', () => {
    ...
    beforeAll(() => {
        Shuwei.Service().register('shuweiExtensionService', () => {
            return {
    ...
    beforeEach(async () => {
        ...
        Shuwei.State.get('notification').notifications = {};
        Shuwei.State.get('notification').growlNotifications = {};
    });
    ...
    it('should throw an error if the upload goes wrong', async () => {
        ...
        expect(Object.keys(Shuwei.State.get('notification').growlNotifications)).toHaveLength(0);
        ...
        const growlNotifications = Shuwei.State.get('notification').growlNotifications;
