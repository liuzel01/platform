...
Shuwei.Component.register('sw-extension-deactivation-modal', swExtensionDeactivationModal);

async function createWrapper(propsData = {}) {
    return shallowMount(await Shuwei.Component.build('sw-extension-deactivation-modal'), {
        propsData: {
