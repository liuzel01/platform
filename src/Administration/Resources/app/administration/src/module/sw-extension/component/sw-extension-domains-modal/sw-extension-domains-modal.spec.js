...
Shuwei.Component.register('sw-extension-domains-modal', swExtensionDomainsModal);

async function createWrapper(propsData) {
    return shallowMount(await Shuwei.Component.build('sw-extension-domains-modal'), {
        propsData: {
