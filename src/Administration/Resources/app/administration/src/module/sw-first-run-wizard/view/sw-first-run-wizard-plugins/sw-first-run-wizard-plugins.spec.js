...
Shuwei.Component.register('sw-first-run-wizard-plugins', swFirstRunWizardPlugins);
...
describe('src/module/sw-first-run-wizard/view/sw-first-run-wizard-plugins', () => {
    ...
    async function createWrapper() {
        return shallowMount(await Shuwei.Component.build('sw-first-run-wizard-plugins'), {
            provide: {
