...
Shuwei.Component.register('sw-first-run-wizard-mailer-selection', swFirstRunWizardMailerSelection);
...
describe('module/sw-first-run-wizard/view/sw-first-run-wizard-modal', () => {
    ...
    const CreateFirstRunWizardMailerSettings = async function CreateFirstRunWizardMailerSettings() {
        return shallowMount(await Shuwei.Component.build('sw-first-run-wizard-mailer-selection'), {
            stubs: {
                'sw-help-text': {
                    template: '<div />',
                },
