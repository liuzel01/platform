...
Shuwei.Component.register('sw-first-run-wizard-welcome', swFirstRunWizardWelcome);
Shuwei.Component.register('sw-plugin-card', swPluginCard);
...
describe('src/module/sw-first-run-wizard/view/sw-first-run-wizard-welcome', () => {
    async function createWrapper() {
        return shallowMount(await Shuwei.Component.build('sw-first-run-wizard-welcome'), {
            stubs: {
                'sw-container': await Shuwei.Component.build('sw-container'),
                'sw-plugin-card': await Shuwei.Component.build('sw-plugin-card'),
            ...
            mixins: [
                Shuwei.Mixin.getByName('notification'),
            ],
        });
    }
