import template from './sw-first-run-wizard-shuwei-domain.html.twig';
import './sw-first-run-wizard-shuwei-domain.scss';
            ...
            const buttonConfig = [
                {
                    ...
                    position: 'left',
                    variant: null,
                    action: 'sw.first.run.wizard.index.shuwei.account',
                    disabled: false,
                },
                {
                    key: 'next',
