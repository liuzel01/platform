...
Shuwei.Component.register('sw-first-run-wizard-modal', swFirstRunWizardModal);
...
describe('module/sw-first-run-wizard/component/sw-first-run-wizard-modal', () => {
    const CreateFirstRunWizardModal = async function CreateFirstRunWizardModal() {
        return shallowMount(await Shuwei.Component.build('sw-first-run-wizard-modal'), {
            stubs: {
    ...
    beforeEach(() => {
        Shuwei.Context.app.firstRunWizard = false;
    ...
    it('should not be closable when frw flag is active', async () => {
        Shuwei.Context.app.firstRunWizard = true;
