...
Shuwei.Component.register('sw-first-run-wizard-paypal-info', swFirstRunWizardPaypalInfo);
...
async function createWrapper() {
    return shallowMount(await Shuwei.Component.build('sw-first-run-wizard-paypal-info'), {
        stubs: {
