...
import Criteria from '@58shuwei-ag/admin-extension-sdk/es/data/Criteria';
import template from './sw-generic-cms-page-assignment.html.twig';
import './sw-generic-cms-page-assignment.scss';

const objectUtils = Shuwei.Utils.object;
...
export default Shuwei.Component.wrapComponentConfig({
    ...
    computed: {
        ...
        changesetGenerator(): ChangesetGenerator {
            return new Shuwei.Data.ChangesetGenerator();
        },
    ...
    methods: {
        ...
        async getCmsPage(): Promise<void> {
            ...
            Shuwei.State.commit('cmsPageState/setCurrentPage', cmsPage);
