...
Shuwei.Component.register('sw-generic-custom-entity-detail', swGenericCustomEntityDetail);
...
async function createWrapper({ activeTab = 'main', routeId = null, entityName = testEntityName } = {}) {
    ...
    return shallowMount(await Shuwei.Component.build('sw-generic-custom-entity-detail'), {
        provide: {
