...
Shuwei.Component.register('sw-custom-entity-input-field', swCustomEntityInputField);

async function createWrapper(propsData = { type: 'string' }) {
    return shallowMount(await Shuwei.Component.build('sw-custom-entity-input-field'), {
        propsData,
        provide: {
        },
        stubs: {
