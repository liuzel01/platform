...
Shuwei.Component.register('sw-generic-seo-general-card', swGenericSeoGeneralCard);
...
async function createWrapper() {
    return shallowMount(await Shuwei.Component.build('sw-generic-seo-general-card'), {
        stubs: {
            'sw-card': true,
            'sw-text-field': {
