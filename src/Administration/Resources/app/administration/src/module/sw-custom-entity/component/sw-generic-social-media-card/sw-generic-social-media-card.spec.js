...
Shuwei.Component.register('sw-generic-social-media-card', swGenericSocialMediaCard);
...
async function createWrapper() {
    return shallowMount(await Shuwei.Component.build('sw-generic-social-media-card'), {
        stubs: {
            'sw-card': true,
            'sw-text-field': {
