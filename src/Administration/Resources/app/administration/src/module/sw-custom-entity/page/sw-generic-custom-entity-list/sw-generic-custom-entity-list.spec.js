...
Shuwei.Component.register('sw-generic-custom-entity-list', swGenericCustomEntityList);
...
async function createWrapper(query = {}) {
    ...
    return shallowMount(await Shuwei.Component.build('sw-generic-custom-entity-list'), {
        provide: {
...
describe('module/sw-custom-entity/page/sw-generic-custom-entity-list', () => {
    ...
    it('changes to content language with the language switch', async () => {
        ...
        expect(Shuwei.State.get('context').api.languageId).toBe(testLanguageId);
