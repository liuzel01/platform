...
Shuwei.Component.register('sw-users-permissions-configuration', swUsersPermissionsConfiguration);

async function createWrapper() {
    return shallowMount(await Shuwei.Component.build('sw-users-permissions-configuration'), {
        stubs: {
