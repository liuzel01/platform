...
Shuwei.Component.register('sw-users-permissions-user-detail', swUsersPermissionsUserDefault);
Shuwei.Component.extend('sw-users-permissions-user-create', 'sw-users-permissions-user-detail', swUsersPermissionsUserCreate);

async function createWrapper(privileges = []) {
    return shallowMount(await Shuwei.Component.build('sw-users-permissions-user-create'), {
        provide: {
            acl: {
                can: (identifier) => {
