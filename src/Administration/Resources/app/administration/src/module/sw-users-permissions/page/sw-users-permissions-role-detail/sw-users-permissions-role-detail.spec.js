...
Shuwei.Component.register('sw-users-permissions-role-detail', swUsersPermissionsRoleDetail);
...
async function createWrapper(
    ...
    return shallowMount(await Shuwei.Component.build('sw-users-permissions-role-detail'), {
        sync: false,
        stubs: {
            'sw-page': { template: `
<div>
