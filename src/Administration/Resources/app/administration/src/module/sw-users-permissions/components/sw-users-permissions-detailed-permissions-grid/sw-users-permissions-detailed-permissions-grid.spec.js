...
Shuwei.Component.register('sw-users-permissions-detailed-permissions-grid', swUsersPermissionsDetailedPermissionsGrid);
...
async function createWrapper(
    ...
    return shallowMount(await Shuwei.Component.build('sw-users-permissions-detailed-permissions-grid'), {
        localVue,
        stubs: {
            'sw-card': true,
        },
...
describe('src/module/sw-users-permissions/components/sw-users-permissions-detailed-permissions-grid', () => {
    beforeAll(async () => {
        const entityDefinitionFactory = Shuwei.Application.getContainer('factory').entityDefinition;
