...
Shuwei.Component.register('sw-users-permissions-role-listing', swUsersPermissionsRoleListing);

async function createWrapper(privileges = []) {
    return shallowMount(await Shuwei.Component.build('sw-users-permissions-role-listing'), {
        provide: {
            repositoryFactory: {
                create: () => ({
