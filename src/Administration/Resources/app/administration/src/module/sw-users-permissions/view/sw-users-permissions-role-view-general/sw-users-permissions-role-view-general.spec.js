...
Shuwei.Component.register('sw-users-permissions-role-view-general', swUsersPermissionsRoleViewGeneral);

async function createWrapper(privileges = []) {
    const localVue = createLocalVue();

    return shallowMount(await Shuwei.Component.build('sw-users-permissions-role-view-general'), {
        localVue,
        stubs: {
            'sw-card': true,
            'sw-field': true,
