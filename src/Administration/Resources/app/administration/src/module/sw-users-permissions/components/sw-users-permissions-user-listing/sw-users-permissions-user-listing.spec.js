...
Shuwei.Component.register('sw-users-permissions-user-listing', swUsersPermissionsUserListing);

async function createWrapper(privileges = []) {
    return shallowMount(await Shuwei.Component.build('sw-users-permissions-user-listing'), {
        provide: {
            acl: {
                can: (identifier) => {
