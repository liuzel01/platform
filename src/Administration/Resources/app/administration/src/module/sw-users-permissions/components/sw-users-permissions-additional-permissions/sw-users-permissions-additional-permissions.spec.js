...
Shuwei.Component.register('sw-users-permissions-additional-permissions', swUsersPermissionsAdditionalPermissions);

describe('module/sw-users-permissions/components/sw-users-permissions-additional-permissions', () => {
    let wrapper;

    beforeEach(async () => {
        wrapper = shallowMount(await Shuwei.Component.build('sw-users-permissions-additional-permissions'), {
            sync: false,
            stubs: {
                'sw-card': true,
                'sw-field': {
