...
Shuwei.Component.register('sw-users-permissions-permissions-grid', swUsersPermissionsPermissionsGrid);
...
async function createWrapper({ privilegesMappings = [], rolePrivileges = [] } = {}) {
    ...
    return shallowMount(await Shuwei.Component.build('sw-users-permissions-permissions-grid'), {
        localVue,
        stubs: {
            'sw-card': true,
