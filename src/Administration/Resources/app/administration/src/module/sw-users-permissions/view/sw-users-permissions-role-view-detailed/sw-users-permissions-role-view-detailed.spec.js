...
Shuwei.Component.register('sw-users-permissions-role-view-detailed', swUsersPermissionsRoleViewDetailed);

async function createWrapper(privileges = []) {
    const localVue = createLocalVue();

    return shallowMount(await Shuwei.Component.build('sw-users-permissions-role-view-detailed'), {
        localVue,
        stubs: {
            'sw-alert': true,
