 ...
 */
Shuwei.Component.register('sw-extension-sdk-module', {
    template,
    ...
    computed: {
        module() {
            return Shuwei.State.get('extensionSdkModules').modules.find(module => module.id === this.id);
        },
        ...
        smartBarButtons() {
            return Shuwei.State.get('extensionSdkModules').smartBarButtons
