...
async function createWrapper() {
    ...
    return shallowMount(await Shuwei.Component.build('sw-extension-sdk-module'), {
        localVue,
        propsData: {
            id: Shuwei.Utils.format.md5(JSON.stringify(module)),
        },
        stubs: {
            'sw-page': true,
            'sw-loader': true,
...
describe('src/module/sw-extension-sdk/page/sw-extension-sdk-module', () => {
    ...
    it('@slow should not time out with menu item', async () => {
        const moduleId = await Shuwei.State.dispatch('extensionSdkModules/addModule', module);
    ...
    it('should show language switch', async () => {
        await Shuwei.State.dispatch('extensionSdkModules/addModule', module);
    ...
    it('should show smart bar button', async () => {
        ...
        await Shuwei.State.dispatch('extensionSdkModules/addModule', module);
        Shuwei.State.commit('extensionSdkModules/addSmartBarButton', {
            locationId: 'jest',
