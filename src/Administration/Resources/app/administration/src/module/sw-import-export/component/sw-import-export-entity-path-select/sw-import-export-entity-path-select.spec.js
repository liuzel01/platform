...
Shuwei.Component.register('sw-import-export-entity-path-select', swImportExportEntityPathSelect);
...
describe('module/sw-import-export/components/sw-import-export-entity-path-select', () => {
    ...
    beforeEach(async () => {
        ...
        Shuwei.EntityDefinition = EntityDefinitionFactory;
        Object.keys(mockEntitySchema).forEach((entity) => {
            Shuwei.EntityDefinition.add(entity, mockEntitySchema[entity]);
        });

        wrapper = shallowMount(await Shuwei.Component.build('sw-import-export-entity-path-select'), {
            stubs: {
    ...
    it('should process translations, prices visibilities and remove property from properties array', async () => {
        ...
        const definition = Shuwei.EntityDefinition.get('product');
    ...
    it('should process assignedProducts and remove property from properties array', async () => {
        ...
        const definition = Shuwei.EntityDefinition.get('product_cross_selling');
