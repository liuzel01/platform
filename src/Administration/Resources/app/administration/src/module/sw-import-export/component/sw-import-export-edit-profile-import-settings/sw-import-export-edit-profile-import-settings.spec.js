...
Shuwei.Component.register('sw-import-export-edit-profile-import-settings', swImportExportEditProfileImportSettings);
...
describe('module/sw-import-export/components/sw-import-export-edit-profile-import-settings', () => {
    ...
    async function createWrapper(profile) {
        return shallowMount(await Shuwei.Component.build('sw-import-export-edit-profile-import-settings'), {
            propsData: {
                profile,
            },
            stubs: {
