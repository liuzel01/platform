...
Shuwei.Component.register('sw-import-export-edit-profile-modal-mapping', swImportExportEditProfileModalMapping);
...
describe('module/sw-import-export/components/sw-import-export-edit-profile-modal-mapping', () => {
    ...
    async function createWrapper(profile) {
        return shallowMount(await Shuwei.Component.build('sw-import-export-edit-profile-modal-mapping'), {
            propsData: {
                profile,
            },
            provide: {
