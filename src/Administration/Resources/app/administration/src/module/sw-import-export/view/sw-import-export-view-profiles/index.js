...
export default {
    ...
    computed: {
        ...
        isNotSystemLanguage() {
            return Shuwei.Context.api.systemLanguageId !== Shuwei.Context.api.languageId;
        },
    ...
    methods: {
        ...
        onDuplicateProfile(item) {
            ...
            return this.profileRepository.clone(item.id, Shuwei.Context.api, behavior).then((clone) => {
                const criteria = new Criteria(1, 25);
        ...
        saveSelectedProfile() {
            this.isLoading = true;
            return this.profileRepository.save(this.selectedProfile, Shuwei.Context.api).then(() => {
                this.showProfileEditModal = false;
                this.selectedProfile = null;
