...
const { Mixin } = Shuwei;
const { debounce, get, flow } = Shuwei.Utils;
...
export default {
    ...
    computed: {
        ...
        currentEntity() {
            ...
            let actualDefinition = Shuwei.EntityDefinition.get(this.entityType);
            ...
            pathParts.forEach((propertyName) => {
                ...
                entityFound = Shuwei.EntityDefinition.has(entity);

                if (entityFound) {
                    actualDefinition = Shuwei.EntityDefinition.get(entity);
                }
            });
        ...
        options() {
            ...
            if (isCustomField) {
                ...
                definition = Shuwei.EntityDefinition.get(this.currentEntity);
            }
    ...
    methods: {
        ...
        processTranslations({ definition, options, properties, path }) {
            ...
            const translationDefinition = Shuwei.EntityDefinition.get(translationProperty.entity);
        ...
        processDeliveries({ definition, options, properties, path }) {
            ...
            const deliveryDefinition = Shuwei.EntityDefinition.get(deliveryProperty.entity);
