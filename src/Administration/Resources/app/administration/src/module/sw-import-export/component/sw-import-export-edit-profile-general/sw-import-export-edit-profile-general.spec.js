...
Shuwei.Component.register('sw-import-export-edit-profile-general', swImportExportEditProfileGeneral);
...
describe('module/sw-import-export/components/sw-import-export-edit-profile-general', () => {
    ...
    async function createWrapper(profile) {
        return shallowMount(await Shuwei.Component.build('sw-import-export-edit-profile-general'), {
            propsData: {
                profile,
            },
            stubs: {
