...
Shuwei.Component.register('sw-import-export-activity', swImportExportActivity);
Shuwei.Component.register('sw-import-export-activity-result-modal', swImportExportActivityResultModal);
Shuwei.Component.register('sw-import-export-activity-log-info-modal', swImportExportActivityLogInfoModal);
...
describe('module/sw-import-export/components/sw-import-export-activity', () => {
    ...
    const createWrapper = async (options = {}) => {
        const defaultOptions = {
            stubs: {
                'sw-entity-listing': await Shuwei.Component.build('sw-entity-listing'),
                'sw-context-menu': await Shuwei.Component.build('sw-context-menu'),
                'sw-context-menu-item': await Shuwei.Component.build('sw-context-menu-item'),
                'sw-context-button': await Shuwei.Component.build('sw-context-button'),
                'sw-import-export-activity-result-modal': await Shuwei.Component.build('sw-import-export-activity-result-modal'),
                'sw-import-export-edit-profile-modal': {
                    template: '<div></div>',
                },
                'sw-import-export-activity-log-info-modal': await Shuwei.Component.build('sw-import-export-activity-log-info-modal'),
                'sw-modal': await Shuwei.Component.build('sw-modal'),
                'sw-grid': await Shuwei.Component.build('sw-grid'),
                'sw-grid-row': await Shuwei.Component.build('sw-grid-row'),
                'sw-grid-column': await Shuwei.Component.build('sw-grid-column'),
        ...
        const wrapper = shallowMount(
            await Shuwei.Component.build('sw-import-export-activity'),
