...
Shuwei.Component.register('sw-import-export-edit-profile-modal-identifiers', swImportExportEditProfileModalIdentifiers);
...
describe('module/sw-import-export/components/sw-import-export-edit-profile-modal-identifiers', () => {
    ...
    async function createWrapper(profile) {
        Object.entries(entitySchemaMock).forEach(([entityName, entityDefinition]) => {
            Shuwei.EntityDefinition.add(entityName, entityDefinition);
        });

        return shallowMount(await Shuwei.Component.build('sw-import-export-edit-profile-modal-identifiers'), {
            propsData: {
                profile,
            },
            provide: {
                importExportUpdateByMapping: new ImportExportUpdateByMappingService(Shuwei.EntityDefinition),
            },
            stubs: {
