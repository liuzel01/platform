...
Shuwei.Component.register('sw-import-export-view-profiles', swImportExportViewProfiles);

async function createWrapper() {
    return shallowMount(await Shuwei.Component.build('sw-import-export-view-profiles'), {
        stubs: {
            'sw-card': true,
