...
Shuwei.Component.register('sw-custom-field-set-detail-base', swCustomFieldSetDetailBase);
...
async function createWrapper(privileges = []) {
    ...
    return shallowMount(await Shuwei.Component.build('sw-custom-field-set-detail-base'), {
        localVue,
        mocks: {
            $i18n: {
