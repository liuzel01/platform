...
Shuwei.Component.register('sw-settings-custom-field-set-detail', swSettingsCustomFieldSetDetail);
Shuwei.Component.extend('sw-settings-custom-field-set-create', 'sw-settings-custom-field-set-detail', swSettingsCustomFieldSetCreate);

async function createWrapper() {
    return shallowMount(await Shuwei.Component.build('sw-settings-custom-field-set-create'), {
        mocks: {
            $tc() {
                return 'translation';
            },
