...
Shuwei.Component.register('sw-settings-custom-field-set-list', swSettingsCustomFieldSetList);
...
async function createWrapper(privileges = []) {
    ...
    return shallowMount(await Shuwei.Component.build('sw-settings-custom-field-set-list'), {
        localVue,
        mocks: {
            $route: {
                params: {
