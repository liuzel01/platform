...
Shuwei.Component.register('sw-custom-field-type-base', swCustomFieldTypeBase);
Shuwei.Component.extend('sw-custom-field-type-select', 'sw-custom-field-type-base', swCustomFieldTypeSelect);
Shuwei.Component.extend('sw-custom-field-type-entity', 'sw-custom-field-type-select', swCustomFieldTypeEntity);
...
async function createWrapper(privileges = [], isNew = true) {
    ...
    return shallowMount(await Shuwei.Component.build('sw-custom-field-type-entity'), {
        localVue,
        mocks: {
            $tc: () => {
                return 'foo';
