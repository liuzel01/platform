...
Shuwei.Component.register('sw-settings-store', swSettingsStore);

async function createWrapper(customString = '') {
    return shallowMount(await Shuwei.Component.build('sw-settings-store'), {
        stubs: {
            'sw-page': {
...
describe('src/module/sw-settings-store/page/sw-settings-store', () => {
    ...
    it('should trim empty spaces from license host', async () => {
        ...
        setTrimAndCompare(' https://www.shuwei.com/de/ ', 'https://www.shuwei.com/de/');
