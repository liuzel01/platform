...
Shuwei.Component.register('sw-media-quickinfo', swMediaQuickinfo);
Shuwei.Component.register('sw-media-collapse', swMediaCollapse);
...
async function createWrapper(mediaServiceFunctions = {}) {
    return shallowMount(await Shuwei.Component.build('sw-media-quickinfo'), {
        mocks: {
            $route: {
                query: {
                    page: 1,
