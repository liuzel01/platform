...
Shuwei.Component.register('sw-media-field', SwMediaField);
Shuwei.Component.register('sw-media-media-item', SwMediaMediaItem);
Shuwei.Component.register('sw-media-base-item', SwMediaBaseItem);
Shuwei.Component.register('sw-media-preview-v2', SwMediaPreviewV2);
Shuwei.Component.register('sw-system-config', swSystemConfig);
...
async function createWrapper(defaultValues = {}) {
    ...
    localVue.filter('mediaName', Shuwei.Filter.getByName('mediaName'));
    localVue.filter('unicodeUri', Shuwei.Filter.getByName('unicodeUri'));
    ...
    return shallowMount(await Shuwei.Component.build('sw-system-config'), {
        ...
        stubs: {
            'sw-form-field-renderer': await Shuwei.Component.build('sw-form-field-renderer'),
            'sw-card': await Shuwei.Component.build('sw-card'),
            'sw-ignore-class': true,
            'sw-sales-channel-switch': await Shuwei.Component.build('sw-sales-channel-switch'),
            'sw-entity-single-select': await Shuwei.Component.build('sw-entity-single-select'),
            'sw-button': await Shuwei.Component.build('sw-button'),
            'sw-label': await Shuwei.Component.build('sw-label'),
            'sw-inherit-wrapper': await Shuwei.Component.build('sw-inherit-wrapper'),
            'sw-inheritance-switch': await Shuwei.Component.build('sw-inheritance-switch'),
            'sw-field': await Shuwei.Component.build('sw-field'),
            'sw-text-field': await Shuwei.Component.build('sw-text-field'),
            'sw-password-field': await Shuwei.Component.build('sw-password-field'),
            'sw-textarea-field': await Shuwei.Component.build('sw-textarea-field'),
            'sw-contextual-field': await Shuwei.Component.build('sw-contextual-field'),
            'sw-switch-field': await Shuwei.Component.build('sw-switch-field'),
            'sw-number-field': await Shuwei.Component.build('sw-number-field'),
            'sw-checkbox-field': await Shuwei.Component.build('sw-checkbox-field'),
            ...
            'sw-single-select': await Shuwei.Component.build('sw-single-select'),
            'sw-multi-select': await Shuwei.Component.build('sw-multi-select'),
            'sw-entity-multi-select': await Shuwei.Component.build('sw-entity-multi-select'),
            'sw-entity-multi-id-select': await Shuwei.Component.build('sw-entity-multi-id-select'),
            'sw-select-base': await Shuwei.Component.build('sw-select-base'),
            'sw-select-result-list': await Shuwei.Component.build('sw-select-result-list'),
            'sw-select-result': await Shuwei.Component.build('sw-select-result'),
            'sw-select-selection-list': await Shuwei.Component.build('sw-select-selection-list'),
            'sw-popover': await Shuwei.Component.build('sw-popover'),
            'sw-highlight-text': await Shuwei.Component.build('sw-highlight-text'),
            'sw-media-field': await Shuwei.Component.build('sw-media-field'),
            'sw-url-field': await Shuwei.Component.build('sw-url-field'),
            'sw-media-media-item': await Shuwei.Component.build('sw-media-media-item'),
            'sw-media-base-item': await Shuwei.Component.build('sw-media-base-item'),
            'sw-media-preview-v2': await Shuwei.Component.build('sw-media-preview-v2'),
            'sw-colorpicker': await Shuwei.Component.build('sw-text-field'),
            'sw-upload-listener': true,
            'sw-simple-search-field': true,
            'sw-loader': true,
            'sw-datepicker': await Shuwei.Component.build('sw-text-field'),
            'sw-text-editor': await Shuwei.Component.build('sw-text-field'),
...
describe('src/app/component/form/sw-custom-field-set-renderer', () => {
    ...
    it('should return ShuweiError when has error', async () => {
        await Shuwei.State.dispatch('error/addApiError', {
            expression: 'SYSTEM_CONFIG.null.dummyKey',
            error: new ShuweiError({ code: 'dummyCode' }),
        });
        ...
        expect(error).toBeInstanceOf(ShuweiError);
    });
