...
Shuwei.Component.register('sw-settings-index', swSettingsIndex);
Shuwei.Component.register('sw-settings-item', swSettingsItem);
...
async function createWrapper(
    ...
    settingsItemsMock.forEach((settingsItem) => {
        Shuwei.State.commit('settingsItems/addItem', settingsItem);
    });

    return shallowMount(await Shuwei.Component.build('sw-settings-index'), {
        mocks: {
            $tc: (path) => {
        ...
        stubs: {
            ...
            'sw-settings-item': await Shuwei.Component.build('sw-settings-item'),
            'router-link': {
...
describe('module/sw-settings/page/sw-settings-index', () => {
    beforeEach(async () => {
        Shuwei.State.get('settingsItems').settingsGroups = {};
    });
    ...
    it('should render settings items in alphabetical order with updated items', async () => {
        ...
        Shuwei.State.commit('settingsItems/addItem', settingsItemToAdd);
