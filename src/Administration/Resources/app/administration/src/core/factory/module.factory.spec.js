...
const { Module, Application } = Shuwei;
...
describe('core/factory/module.factory.js', () => {
    ...
    it('should add settings item if feature flag is active', () => {
        ...
        expect(Shuwei.State.get('settingsItems').settingsGroups).toEqual(expectedSettingsItem);
    });
    ...
    it('should not add settings item if feature flag is deactivated', () => {
        ...
        expect(Shuwei.State.get('settingsItems').settingsGroups).toEqual({});
    });
