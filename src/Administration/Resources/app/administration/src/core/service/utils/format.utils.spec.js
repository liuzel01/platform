...
describe('src/core/service/utils/format.utils.js', () => {
    ...
    describe('date', () => {
        const setLocale = (locale) => {
            jest.spyOn(Shuwei.Application.getContainer('factory').locale, 'getLastKnownLocale')
    ...
    describe('currency', () => {
        const currencyFilter = Shuwei.Utils.format.currency;
