...
describe('core/service/login.service.js', () => {
    ...
    it('should login and return the bearer token', async () => {
        ...
        const auth = await loginService.loginByUsername('admin', 'shuwei');
    ...
    it('should get a new token', async () => {
        ...
        await loginService.loginByUsername('admin', 'shuwei');
    ...
    it('should start auto refresh the token after login', async () => {
        jest.useFakeTimers();
        Shuwei.Context.app.lastActivity = Math.round(+new Date() / 1000);
