...
import { handleFactory, send } from '@58shuwei-ag/admin-extension-sdk/es/channel';
import SerializerFactory from '@58shuwei-ag/admin-extension-sdk/es/_internals/serializer';
    ...
    it('should update entity', async () => {
        ...
        jest.spyOn(window, 'addEventListener').mockImplementationOnce((event, handler) => {
            ...
            const data = {
                ...
                _callbackId: Shuwei.Utils.createId(),
            };
