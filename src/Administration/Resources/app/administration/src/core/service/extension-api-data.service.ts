...
import { updateSubscriber, register, handleGet } from '@58shuwei-ag/admin-extension-sdk/es/data';
    ...
    updateSubscriber(id, (value) => {
        ...
        function setObject(transferObject: transferObject, prePath: string|null = null): void {
            ...
            Object.keys(transferObject).forEach((property) => {
                ...
                if (Shuwei.Utils.hasOwnProperty(transferObject[property], 'getDraft', this) && typeof transferObject[property].getDraft === 'function') {
                    setObject({ [property]: Shuwei.Utils.object.cloneDeep(transferObject[property]) }, realPath);
                ...
                scope.$set(
                    Shuwei.Utils.object.get(scope, parsedPath.pathToLastSegment) as Vue,
        ...
        if (path.includes('.')) {
            ...
            scope.$set(Shuwei.Utils.object.get(scope, newPath) as Vue, lastPath, value.data);
