...
namespace Shuwei\Core\Profiling;

use Shuwei\Core\Framework\Log\Package;
use Shuwei\Core\Profiling\Integration\ProfilerInterface;
...
{
    /**
     * Profilers will be activated over the shuwei.yaml file
     *
     ...
     * @return mixed
     */
    public static function trace(string $name, \Closure $closure, string $category = 'shuwei', array $tags = [])
    {
