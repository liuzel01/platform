...
namespace Shuwei\Core\Framework\Plugin\Requirement;
...
use Shuwei\Core\Framework\Plugin\Requirement\Exception\ComposerNameMissingException;
use Shuwei\Core\Framework\Plugin\Requirement\Exception\ConflictingPackageException;
...
class RequirementsValidator
{
    ...
    private Composer $shuweiProjectComposer;
    ...
    public function validateRequirements(PluginEntity $plugin, Context $context, string $method): void
    {
        ...
        $this->shuweiProjectComposer = $this->getComposer($this->projectDir);
    ...
    private function checkComposerDependencies(
        ...
        foreach ($packages as $package) {
            // Ignore Shuwei plugins. They are checked separately in `validateInstalledPlugins`
    ...
    {
        $packages = $this->shuweiProjectComposer->getRepositoryManager()->getLocalRepository()->getPackages();
