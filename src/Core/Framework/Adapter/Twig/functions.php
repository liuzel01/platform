...
use Shuwei\Core\Framework\DataAbstractionLayer\FieldVisibility;
use Shuwei\Core\Framework\Struct\Struct;
use Twig\Environment;
use Twig\Source;
use Twig\Template;

if (!\function_exists('Shuwei\Core\Framework\Adapter\Twig\sw_get_attribute')) {
    /**
...
if (!\function_exists('Shuwei\Core\Framework\Adapter\Twig\sw_escape_filter')) {
    /**
     * Escapes a string.
     *
