...
use Shuwei\Core\Framework\Store\Event\FirstRunWizardStartedEvent;
use Shuwei\Core\Framework\Store\Exception\LicenseDomainVerificationException;
use Shuwei\Core\Framework\Store\Exception\StoreLicenseDomainMissingException;
use Shuwei\Core\Framework\Store\Struct\AccessTokenStruct;
use Shuwei\Core\Framework\Store\Struct\DomainVerificationRequestStruct;
use Shuwei\Core\Framework\Store\Struct\FrwState;
use Shuwei\Core\Framework\Store\Struct\LicenseDomainCollection;
use Shuwei\Core\Framework\Store\Struct\LicenseDomainStruct;
use Shuwei\Core\Framework\Store\Struct\PluginCategoryStruct;
use Shuwei\Core\Framework\Store\Struct\PluginRecommendationCollection;
use Shuwei\Core\Framework\Store\Struct\PluginRegionCollection;
use Shuwei\Core\Framework\Store\Struct\PluginRegionStruct;
use Shuwei\Core\Framework\Store\Struct\ShopUserTokenStruct;
use Shuwei\Core\Framework\Store\Struct\StorePluginStruct;
...
class FirstRunWizardService
{
    ...
    public function frwLogin(string $shuweiId, string $password, Context $context): void
    {
        $accessTokenResponse = $this->frwClient->frwLogin($shuweiId, $password, $context);
