...
use Shuwei\Core\Framework\Store\Exception\StoreTokenMissingException;
...
use Shuwei\Core\Framework\Store\Struct\LicenseStruct;
...
use Shuwei\Core\Framework\Store\Struct\StoreActionStruct;
use Shuwei\Core\Framework\Store\Struct\StoreLicenseViolationStruct;
use Shuwei\Core\Framework\Store\Struct\StoreLicenseViolationTypeStruct;
use Shuwei\Core\Framework\Store\Struct\StoreUpdateStruct;
...
class StoreClient
{
    ...
    public function loginWithShuweiId(string $shuweiId, string $password, Context $context): void
    {
    ...
    public function getPluginCompatibilities(Context $context, string $futureVersion, PluginCollection $pluginCollection): array
    {
        ...
        $response = $this->client->request(
            ...
            [
                ...
                'headers' => $this->getHeaders($context),
                'json' => [
                    'futureShuweiVersion' => $futureVersion,
                    'plugins' => $pluginArray,
                ],
            ]
        );
    ...
    {
        return $this->instanceService->getShuweiVersion();
    }
