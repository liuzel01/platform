...
use Shuwei\Core\Framework\Api\Exception\ExpectationFailedException;
use Shuwei\Core\Framework\Log\Package;
use Shuwei\Core\Framework\Routing\ApiRouteScope;
...
{
    private const SHUWEI_CORE_PACKAGES = [
        'shuwei/platform',
        'shuwei/core',
    ...
    private function checkPackages(Request $request): array
    {
        ...
        foreach ($extensionConstraints as $extension) {
            ...
            if (isset($plugins[$name])) {
                ...
                if (\in_array($name, self::SHUWEI_CORE_PACKAGES, true)) {
                    $installedVersion = $this->shuweiVersion;
                }
            }
