...
use Shuwei\Core\Framework\Api\Exception\InvalidVersionNameException;
use Shuwei\Core\Framework\Api\Exception\LiveVersionDeleteException;
use Shuwei\Core\Framework\Api\Exception\MissingPrivilegeException;
use Shuwei\Core\Framework\Api\Exception\NoEntityClonedException;
use Shuwei\Core\Framework\Api\Exception\ResourceNotFoundException;
...
use Shuwei\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtection;
use Shuwei\Core\Framework\DataAbstractionLayer\EntityProtection\EntityProtectionValidator;
...
use Shuwei\Core\Framework\DataAbstractionLayer\Exception\DefinitionNotFoundException;
use Shuwei\Core\Framework\DataAbstractionLayer\Exception\MissingReverseAssociation;
...
class ApiController extends AbstractController
{
    ...
    #[Route(path: '/api/_action/clone/{entity}/{id}', name: 'api.clone', requirements: ['version' => '\d+', 'entity' => '[a-zA-Z-]+', 'id' => '[0-9a-f]{32}'], methods: ['POST'])]
    ...
    #[Route(path: '/api/_action/version/{entity}/{id}', name: 'api.createVersion', requirements: ['version' => '\d+', 'entity' => '[a-zA-Z-]+', 'id' => '[0-9a-f]{32}'], methods: ['POST'])]
    ...
    #[Route(path: '/api/_action/version/merge/{entity}/{versionId}', name: 'api.mergeVersion', requirements: ['version' => '\d+', 'entity' => '[a-zA-Z-]+', 'versionId' => '[0-9a-f]{32}'], methods: ['POST'])]
    ...
    #[Route(path: '/api/_action/version/{versionId}/{entity}/{entityId}', name: 'api.deleteVersion', requirements: ['version' => '\d+', 'entity' => '[a-zA-Z-]+', 'id' => '[0-9a-f]{32}'], methods: ['POST'])]
    ...
    private function resolveSearch(Request $request, Context $context, string $entityName, string $path): array
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Shuwei\Core\Content\Product\Definition\ProductPriceDefinition
             */
             ...
             * $definition:     \Shuwei\Core\Content\Product\Aggregate\ProductManufacturer\ProductManufacturerDefinition
             */
             ...
             * $definition:     \Shuwei\Core\Checkout\Order\Aggregate\OrderCustomer\OrderCustomerDefinition
             */
    ...
    private function getDefinitionOfPath(string $entityName, string $path, Context $context): EntityDefinition
    {
        ...
        if ($association instanceof ManyToManyAssociationField) {
             ...
             * $definition:     \Shuwei\Core\Content\Category\CategoryDefinition
             */
