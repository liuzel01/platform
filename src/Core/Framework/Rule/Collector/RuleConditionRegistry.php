...
namespace Shuwei\Core\Framework\Rule\Collector;

use Shuwei\Core\Framework\Log\Package;
use Shuwei\Core\Framework\Rule\Exception\InvalidConditionException;
use Shuwei\Core\Framework\Rule\FlowRule;
