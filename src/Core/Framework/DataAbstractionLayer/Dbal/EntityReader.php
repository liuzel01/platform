...
use Shuwei\Core\Framework\DataAbstractionLayer\Dbal\Exception\ParentAssociationCanNotBeFetched;
...
class EntityReader implements EntityReaderInterface
{
    ...
    private function loadManyToMany(
        ...
        // the ids are extracted in the entity hydrator (see: \Shuwei\Core\Framework\DataAbstractionLayer\Dbal\EntityHydrator::extractManyToManyIds)
