...
use Shuwei\Core\Framework\DataAbstractionLayer\Write\FieldException\UnexpectedFieldException;
...
{
    /**
     * @deprecated tag:v6.6.0 - Will be removed, use \Shuwei\Core\Framework\Util\Json::encode instead
     */
