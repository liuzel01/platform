...
use Shuwei\Core\Framework\Api\EventListener\ErrorResponseFactory;
use Shuwei\Core\Framework\Log\Package;
use Shuwei\Core\Framework\ShuweiHttpException;
use Symfony\Component\HttpFoundation\Response;

#[Package('core')]
class WriteException extends ShuweiHttpException
{
    ...
    public function getErrors(bool $withTrace = false): \Generator
    {
        foreach ($this->getExceptions() as $innerException) {
            if ($innerException instanceof ShuweiHttpException) {
