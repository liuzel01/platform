...
use Shuwei\Core\Framework\RateLimiter\RateLimiter;
use Shuwei\Core\Framework\RateLimiter\RateLimiterFactory;
...
class RateLimiterCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $rateLimiterConfig = $container->getParameter('shuwei.api.rate_limiter');
        ...
        $container->setDefinition('shuwei.rate_limiter', $rateLimiter);
    }
