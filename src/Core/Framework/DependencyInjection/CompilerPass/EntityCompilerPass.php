...
use Shuwei\Core\Framework\DataAbstractionLayer\VersionManager;
...
class EntityCompilerPass implements CompilerPassInterface
{
    ...
    private function collectDefinitions(ContainerBuilder $container): void
    {
        $entityNameMap = [];
        $repositoryNameMap = [];
        $services = $container->findTaggedServiceIds('shuwei.entity.definition');
    ...
    {
        $servicesIds = array_keys($container->findTaggedServiceIds('shuwei.field_serializer'));
    ...
    {
        $servicesIds = array_keys($container->findTaggedServiceIds('shuwei.field_resolver'));
    ...
    {
        $servicesIds = array_keys($container->findTaggedServiceIds('shuwei.field_accessor_builder'));
