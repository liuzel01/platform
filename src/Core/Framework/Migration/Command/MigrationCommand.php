...
namespace Shuwei\Core\Framework\Migration\Command;

use Shuwei\Core\Framework\Adapter\Console\ShuweiStyle;
use Shuwei\Core\Framework\Log\Package;
use Shuwei\Core\Framework\Migration\Exception\MigrateException;
use Shuwei\Core\Framework\Migration\Exception\UnknownMigrationSourceException;
...
class MigrationCommand extends Command
{
    ...
    public function __construct(
        ...
        string $shuweiVersion
    ) {
        parent::__construct();

        $this->loader = $loader;
        $this->shuweiVersion = $shuweiVersion;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->io = new ShuweiStyle($input, $output);
        ...
        if ($total > 0) {
            $this->cache->clear();
            $this->io->writeln('cleared the shuwei cache');
        }
