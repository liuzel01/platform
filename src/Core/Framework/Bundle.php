...
use Shuwei\Core\Framework\Adapter\Asset\AssetPackageService;
use Shuwei\Core\Framework\Adapter\Filesystem\PrefixFilesystem;
use Shuwei\Core\Framework\DependencyInjection\CompilerPass\BusinessEventRegisterCompilerPass;
...
abstract class Bundle extends SymfonyBundle
{
    ...
    /**
     * Returns a list of all action event class references of this bundle. The events will be registered inside the `\Shuwei\Core\Framework\Event\BusinessEventRegistry`.
     *
