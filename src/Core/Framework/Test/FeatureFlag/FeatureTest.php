...
namespace Shuwei\Core\Framework\Test\FeatureFlag;

use PHPUnit\Framework\TestCase;
use Shuwei\Core\Framework\Adapter\Twig\Extension\FeatureFlagExtension;
...
class FeatureTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Feature::registerFeatures($this->getContainer()->getParameter('shuwei.feature.flags'));
    }
    ...
    public function testConfigGetAllReturnsAllAndTracksState(): void
    {
        ...
        $featureFlags = array_keys($this->getContainer()->getParameter('shuwei.feature.flags'));
