...
use Shuwei\Core\Checkout\Cart\CartRuleLoader;
use Shuwei\Core\Checkout\Test\Payment\Handler\V630\SyncTestPaymentHandler;
...
use Shuwei\Core\System\SalesChannel\Context\SalesChannelContextFactory;
...
trait SalesChannelApiTestBehaviour
{
    ...
    public function login(?KernelBrowser $browser = null): string
    {
        ...
        $customerId = $this->createCustomer('shuwei', $email);
