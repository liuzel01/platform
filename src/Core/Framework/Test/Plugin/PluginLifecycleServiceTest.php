...
use Shuwei\Core\Framework\Test\Migration\MigrationTestBehaviour;
...
class PluginLifecycleServiceTest extends TestCase
{
    ...
    public function testRemoveMigrationsCannotRemoveShuweiMigrations(): void
    {
        $this->removeMigrationsCannotRemoveShuweiMigrations($this->context);
    }
    ...
    public function testRemoveMigrationsCannotRemoveShuweiMigrationsWithNonStandardLanguage(): void
    {
        $this->removeMigrationsCannotRemoveShuweiMigrations($this->createNonStandardLanguageContext());
    }
    ...
    {
        static::markTestSkipped('This test needs the frontend bundle installed.');
        $this->addTestPluginToKernel(
    ...
    private function removeMigrationsCannotRemoveShuweiMigrations(Context $context): void
    {
        $this->pluginService->refreshPlugins($context, new NullIO());
        ...
        $_SERVER['FAKE_MIGRATION_NAMESPACE'] = 'Shuwei\\Core';
