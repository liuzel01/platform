...
use Shuwei\Core\Framework\Plugin\Exception\KernelPluginLoaderException;
...
use Shuwei\Core\Framework\Test\Plugin\_fixture\bundles\GizmoBundle;
...
class StaticKernelPluginLoaderTest extends TestCase
{
    ...
    public function testExpectExceptionWithFakePlugin(): void
    {
        ...
        $this->expectException(KernelPluginLoaderException::class);
        $this->expectExceptionMessage('Failed to load plugin "SwagTest". Reason: Plugin class "SwagTest\SwagTestFake" must extend "Shuwei\Core\Framework\Plugin"');
        $loader->initializePlugins(TEST_PROJECT_DIR);
    }
