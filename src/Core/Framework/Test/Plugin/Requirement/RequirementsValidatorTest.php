...
namespace Shuwei\Core\Framework\Test\Plugin\Requirement;
...
use Shuwei\Core\TestBootstrapper;
use Symfony\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter;

/**
 * @internal
 *
 * @covers \Shuwei\Core\Framework\Plugin\Requirement\RequirementsValidator
 */
class RequirementsValidatorTest extends TestCase
{
    ...
    public function testValidateRequirementsDoNotMatch(): void
    {
        ...
        static::assertContains('shuwei/platform', $packages);
