...
namespace Shuwei\Core\Framework\Test\Migration;
...
use Shuwei\Core\Framework\Test\TestCaseHelper\ReflectionHelper;
    ...
    public function addMigrationSources(): void
    {
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_invalid_namespace' => 'Shuwei\Core\Framework\Test\Migration\_test_migrations_invalid_namespace']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_valid' => 'Shuwei\Core\Framework\Test\Migration\_test_migrations_valid']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_valid_run_time' => 'Shuwei\Core\Framework\Test\Migration\_test_migrations_valid_run_time']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_valid_run_time_exceptions' => 'Shuwei\Core\Framework\Test\Migration\_test_migrations_valid_run_time_exceptions']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_trigger_with_trigger_' => 'Shuwei\Core\Framework\Test\Migration\_test_trigger_with_trigger_']
            )
        );
