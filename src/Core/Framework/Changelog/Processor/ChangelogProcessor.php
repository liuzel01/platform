...
namespace Shuwei\Core\Framework\Changelog\Processor;

use Shuwei\Core\Framework\Changelog\ChangelogFile;
use Shuwei\Core\Framework\Changelog\ChangelogFileCollection;
use Shuwei\Core\Framework\Changelog\ChangelogParser;
...
class ChangelogProcessor
{
    ...
    private function getPlatformRoot(): string
    {
        if (!isset($this->platformRoot)) {
            ...
            if ($composerJson === null || $composerJson['name'] !== '58shuwei/platform') {
