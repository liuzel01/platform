...
use Shuwei\Core\Framework\Update\Api\UpdateController;
use Shuwei\Core\Framework\Update\Event\UpdatePostFinishEvent;
use Shuwei\Core\Framework\Update\Event\UpdatePreFinishEvent;
...
class SystemUpdateFinishCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $newVersion = $containerWithoutPlugins->getParameter('kernel.shuwei_version');
