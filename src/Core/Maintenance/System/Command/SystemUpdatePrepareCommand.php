...
class SystemUpdatePrepareCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $currentVersion = $this->container->getParameter('kernel.shuwei_version');
        if (!\is_string($currentVersion)) {
            throw new \RuntimeException('Container parameter "kernel.shuwei_version" needs to be a string');
        }
