...
use Shuwei\Core\Content\Media\Event\UnusedMediaSearchEvent;
 ...
 * @internal
 *
 *  * @codeCoverageIgnore This would be useless as a unit test. It is integration tested here: \Shuwei\Tests\Integration\Core\Content\Media\Subscriber\CustomFieldsUnusedMediaSubscriberTest
 */
#[Package('core')]
