...
use Shuwei\Core\Content\Media\Exception\CouldNotRenameFileException;
use Shuwei\Core\Content\Media\Exception\DisabledUrlUploadFeatureException;
use Shuwei\Core\Content\Media\Exception\DuplicatedMediaFileNameException;
...
use Shuwei\Core\Content\Media\Exception\FileExtensionNotSupportedException;
use Shuwei\Core\Content\Media\Exception\IllegalFileNameException;
use Shuwei\Core\Content\Media\Exception\IllegalUrlException;
use Shuwei\Core\Content\Media\Exception\MediaFolderNotFoundException;
use Shuwei\Core\Content\Media\Exception\MediaNotFoundException;
use Shuwei\Core\Content\Media\Exception\MissingFileException;
use Shuwei\Core\Content\Media\Exception\MissingFileExtensionException;
use Shuwei\Core\Content\Media\Exception\StrategyNotFoundException;
use Shuwei\Core\Content\Media\Exception\ThumbnailCouldNotBeSavedException;
use Shuwei\Core\Content\Media\Exception\ThumbnailNotSupportedException;
use Shuwei\Core\Content\Media\Exception\UploadException;
