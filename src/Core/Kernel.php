...
use Shuwei\Core\Framework\Api\Controller\FallbackController;
...
class Kernel extends HttpKernel
{
     ...
     */
    final public const SHUWEI_FALLBACK_VERSION = '6.5.9999999.9999999-dev';
     ...
     * @var string
     */
    protected $shuweiVersion;

    /**
     * @var string|null
     */
    protected $shuweiVersionRevision;
    ...
    public function __construct(
        ...
        ?string $version = self::SHUWEI_FALLBACK_VERSION,
    ...
    protected function getKernelParameters(): array
    {
        ...
        return array_merge(
            ...
            [
                ...
                'kernel.shuwei_core_dir' => $coreDir,
    ...
    protected function getCacheHash(): string
    {
        ...
        return md5((string) \json_encode([
            $this->cacheId,
            substr((string) $this->shuweiVersionRevision, 0, 8),
    ...
    {
        $shuweiSkipConnectionVariables = EnvironmentHelper::getVariable('SHUWEI_SKIP_CONNECTION_VARIABLES', false);

        if ($shuweiSkipConnectionVariables) {
            return;
        }
        ...
        try {
            ...
            $timeZoneSupportEnabled = (bool) EnvironmentHelper::getVariable('SHUWEI_DBAL_TIMEZONE_SUPPORT_ENABLED', false);
