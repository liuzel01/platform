...
use Shuwei\Core\Installer\InstallerKernel;
...
return function (array $context) {
    ...
    $shuweiHttpKernel = new HttpKernel($appEnv, $debug, $classLoader);

    return new class($shuweiHttpKernel) implements HttpKernelInterface, TerminableInterface {
