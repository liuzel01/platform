...
if (installButton) {
    installButton.onclick = async function () {
        ...
        const shuweiVersion = document.getElementById('shuweiVersion');

        const installResponse = await fetch(`${baseUrl}/install/_run?shuweiVersion=` + shuweiVersion.value, {method: 'POST'});
...
if (updateButton) {
    updateButton.onclick = async function () {
        ...
        const updateRun = await fetch(`${baseUrl}/update/_run?shuweiVersion=${shuweiVersion.value}`, {method: 'POST'});
