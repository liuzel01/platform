...
namespace Shuwei\WebInstaller\Tests\Listener;

use PHPUnit\Framework\TestCase;
use Shuwei\WebInstaller\Listener\InstallerLocaleListener;
 ...
 * @internal
 *
 * @covers \Shuwei\WebInstaller\Listener\InstallerLocaleListener
 */
