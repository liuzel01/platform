...
use Shuwei\WebInstaller\Controller\PhpConfigController;
 ...
 * @internal
 *
 * @covers \Shuwei\WebInstaller\Controller\PhpConfigController
 */
class PhpConfigControllerTest extends TestCase
{
    ...
    public function testSetConfigOnInstall(): void
    {
        ...
        $recoveryManager->method('getShuweiLocation')->willThrowException(new \RuntimeException('cannot find shuwei'));
