...
use Shuwei\WebInstaller\Controller\InstallController;
 ...
 * @internal
 *
 * @covers \Shuwei\WebInstaller\Controller\InstallController
...
class InstallControllerTest extends TestCase
{
    public function testStartPage(): void
    {
        ...
        $recovery->method('getShuweiLocation')->willReturn('asd');
    ...
    public function testInstall(): void
    {
        ...
        $recovery = $this->createMock(RecoveryManager::class);
        $recovery->method('getShuweiLocation')->willReturn('location');
        ...
        $request->query->set('shuweiVersion', '6.4.10.0');
