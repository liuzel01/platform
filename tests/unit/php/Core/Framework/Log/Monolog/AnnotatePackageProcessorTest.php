...
namespace Shuwei\Tests\Unit\Core\Framework\Log\Monolog;

use Monolog\Handler\AbstractHandler;
use Monolog\Level;
use Monolog\LogRecord;
use PHPUnit\Framework\TestCase;
use Shuwei\Core\Framework\Log\Monolog\AnnotatePackageProcessor;
...
/**
 * @covers \Shuwei\Core\Framework\Log\Monolog\AnnotatePackageProcessor
 *
 * @internal
 */
#[Package('cause')]
 ...
 */
#[Package('exception')]
class TestException extends ShuweiHttpException
{
 ...
 * @internal
 */
class TestExceptionNoPackage extends ShuweiHttpException
{
    public function getErrorCode(): string
    {
        return '500';
