...
namespace Shuwei\Tests\Unit\Core\System\SystemConfig\Api;
...
use Shuwei\Core\System\SystemConfig\Api\SystemConfigController;
use Shuwei\Core\System\SystemConfig\Service\ConfigurationService;
use Shuwei\Core\System\SystemConfig\SystemConfigService;
use Shuwei\Core\System\SystemConfig\Validation\SystemConfigValidator;
 ...
 * @internal
 *
 * @covers \Shuwei\Core\System\SystemConfig\Api\SystemConfigController
 */
class SystemConfigControllerTest extends TestCase
{
    ...
    public function testBatchSaveConfigurationSuccess(): void
    {
        ...
        $request = new Request();
        $request->request->set('null', ['core'=>22]);
